  ...
  return (
    <div className="widget">
      <div className="widget-header">
        <h2>Next.js Widget Component</h2>
      ...
      <div className="widget-content">
        ...
        <div className="info-section">
          ...
          <ul className="info-list">
            <li><strong>Remote Name:</strong> playgroundNext</li>
            <li><strong>Exposed Module:</strong> ./Widget</li>
            <li><strong>Port:</strong> 3003</li>
            <li><strong>Framework:</strong> Next.js-style (Vite + React)</li>
          </ul>
        </div>

        <div className="info-section success">
          <h3>✅ Status</h3>
          <p>Next.js playground is running successfully!</p>
